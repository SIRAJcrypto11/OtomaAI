...
const dummyAgents = [
    { id: 1, name: "CS Bot Tokopedia", type: "Customer Service", status: "Active", messages: "12.4k", lastActive: "2 min ago" },
    { id: 2, name: "Lead Gen WhatsApp", type: "Sales", status: "Active", messages: "5.2k", lastActive: "15 min ago" },
    { id: 3, name: "Financial Analyst", type: "Internal Tool", status: "Paused", messages: "842", lastActive: "2 days ago" },
];
    ...
    return (
        <div className="flex-1 p-8 overflow-y-auto bg-slate-50">
            <div className="mb-8 flex items-center justify-between">
                ...
                <button className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium shadow-sm hover:bg-blue-700 transition-colors flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {dummyAgents.map((agent) => (
                    <div key={agent.id} className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="mt-4 flex gap-2">
                            <Link href={`/dashboard/workflows`} className="flex-1 bg-white border border-slate-200 text-slate-700 text-center py-2 rounded-lg text-sm font-medium hover:bg-slate-50 transition-colors">
                                Edit Workflow
                            </Link>
                ...
                {/* Create New Card */}
                <button className="bg-slate-50 rounded-xl border-2 border-dashed border-slate-200 p-6 flex flex-col items-center justify-center text-slate-500 hover:text-blue-600 hover:border-blue-300 hover:bg-blue-50/50 transition-all min-h-[280px]">
